...
public class RegisterNewUserNameRulesValidatorImpl implements RegisterNewUserNameRulesValidator {
    ...
    public RegisterNewUserNameRulesValidatorImpl(UserNameIsNotNullRule userNameIsNotNullRule, UserNameIsNotEmpyRule userNameIsNotEmpyRule,
                                                 UserNameFormatIsValidRule userNameFormatIsValidRule, UserNameLenghIsValidRule userNameLenghIsValidRule) {
