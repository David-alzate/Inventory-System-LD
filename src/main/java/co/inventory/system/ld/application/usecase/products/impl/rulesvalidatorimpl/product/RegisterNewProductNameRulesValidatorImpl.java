...
public class RegisterNewProductNameRulesValidatorImpl implements RegisterNewProductNameRulesValidator {
	...
	public RegisterNewProductNameRulesValidatorImpl(ProductNameIsNotEmpyRule productNameIsNotEmpyRule,
			ProductNameIsNotNullRule productNameIsNotNullRule,
			ProductNameFormatIsValidRule productNameFormatIsValidRule,
			ProductNameLenghIsValidRule productNameLenghIsValidRule) {
