...
public class RegisterNewProductTypeNameRulesValidatorImpl implements RegisterNewProductTypeNameRulesValidator {
    ...
    public RegisterNewProductTypeNameRulesValidatorImpl(ProductTypeNameFormatIsValidRule productTypeNameFormatIsValidRule, ProductTypeNameIsNotEmpyRule productTypeNameIsNotEmpyRule, ProductTypeNameLenghIsValidRule productTypeNameLenghIsValidRule, ProductTypeNameIsNotNullRule productTypeNameIsNotNullRule) {
